...
const AutomationPage = () => {
  ...
  return (
    <div className="w-full max-w-8xl mx-auto">
      <div className="flex-1 flex flex-col p-4 md:p-6 bg-gray-50/50 dark:bg-gray-950 min-w-0 transition-colors duration-200">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-3">
              <div className="p-2 bg-yellow-100 dark:bg-yellow-950/50 rounded-lg">
                <FiZap size={28} className='text-yellow-600 dark:text-yellow-400' />
              </div>
              Automation & Patching
            </h1>
            <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm md:text-base">
              Manage scripts, patch policies, and schedule background jobs across your fleet.
            </p>
          </div>
